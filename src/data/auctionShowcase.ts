...
export const showcaseItems: ShowcaseItem[] = [
  ...
  },
  {
    ...
    description: '水島翔の愛車！映画「ワイルドスピードX3 TOKYO DRIFT」のDK（タカシ）車と同型のZ33。ヴェイルサイド製エアロ＆ワイドボディ仕様。',
    longDescription:
      '漁師トレーダー翔（水島翔）の愛車、日産フェアレディZ Z33をチャリティーオークションに出品！\n\n映画「ワイルドスピードX3 TOKYO DRIFT」でDK（タカシ）が駆った車両と同型の Z33 をベースに、ヴェイルサイド製エアロパーツ、ワイドボディキット、バイナルグラフィック、深リムホイール、大型リヤウイングと、劇中車を彷彿とさせるフルカスタム仕様に仕上げた一台です。\n\nオリジナルのカスタムグラフィックラッピングをまとい、サーキット走行会・カーショー・SNS映え、どのシーンでも視線を独り占めする唯一無二のビルドです。',
    youtuber: '水島 翔',
    startPrice: 8000000,
    ...
    specs: [
      ...
      { label: '外装', value: 'ヴェイルサイドエアロ＋カスタムグラフィック' },
    ...
    highlights: [
      ...
      'ヴェイルサイドエアロ＋大型リヤウイングで劇中車の雰囲気を再現',
